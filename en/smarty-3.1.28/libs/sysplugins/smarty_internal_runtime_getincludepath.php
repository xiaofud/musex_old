<?php
/**
 * Smarty read include_test path plugin
 *
 * @package    Smarty
...
class Smarty_Internal_Runtime_GetIncludePath
{
    ...
    /**
     * include_test path directory cache
     *
     * @var array
     */
    ...
    /**
     * Check if include_test path was updated
     *
     * @param \Smarty $smarty
     *
     * @return bool
    ...
    /**
     * return array with include_test path directories
     *
     * @param \Smarty $smarty
     *
     * @return array
