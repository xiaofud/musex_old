...
class Smarty_Internal_Compile_Include extends Smarty_Internal_CompileBase
{
    ...
    /**
     * Compiles code for the {include_test} tag
     *
    ...
    public function compile($args, Smarty_Internal_SmartyTemplateCompiler $compiler, $parameter)
    {
        ...
        // caching was on and {include_test} is not in nocache mode
        ...
        /*
        * if the {include_test} tag provides individual parameter for caching or compile_id
        ...
        */
        ...
        // delete {include_test} standard attributes
